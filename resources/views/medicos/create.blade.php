...
@section('title', 'Cadastro de novo de médico')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <form role="form" action="{{ route('admin.medicos.store') }}" method="post">
                    {!! csrf_field() !!}
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group {{ $errors->has('crm') ? 'has-error' : '' }}">
                                    <label>CRM</label>
                                    <input type="text" name="crm" class="form-control" placeholder="CRM" value="{{ old('crm') }}" autocomplete="nop">
                                </div>
                            </div>
                        </div>
                       ...
                       <div class="row">
                            <div class="col-md-2">
                                <div class="form-group {{ $errors->has('especialidade_id') ? 'has-error' : '' }}">
                                    ...
                                    <select class="form-control" style="width: 100%;" name="especialidade_id" value="{{ old('especialidade_id') }}" autocomplete="nop">
